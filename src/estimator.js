const covid19ImpactEstimator = (data) => {
  ...
  const impactHospitalBedsByRequestedTime = Math.round(totalBeds - casesByRequestedTime);
  ...
  const hospitalBedsByRequestedTime = Math.round(totalBeds - severeCasesByRequestedTime);
