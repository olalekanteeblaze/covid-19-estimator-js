const covid19ImpactEstimator = (data) => {
  ...
  const casesByRequestedTime = Math.trunc(impactInfectionsByRequestedTime * 0.15) - 1;
  ...
  const severeCasesByRequestedTime = Math.trunc(severeImpactInfectionsByRequestedTime * 0.15) - 1;
